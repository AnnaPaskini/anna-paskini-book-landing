// app/Schema.tsx
// JSON-LD structured data for dadmemorybooks.com homepage.
// Rendered inside <head> via layout.tsx.
    ...
    const data = {
        ...
        "@graph": [
            ...
            },
            {
                ...
                name: "Dad Memory Books",
                description:
                    "Activity books for men with dementia, created by a daughter who found a way to connect with her dad. Free 15-Minute Visit Guide available.",
