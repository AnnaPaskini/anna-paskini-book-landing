// ============================================================
// FaqSchema.tsx
// Вставляется в page.tsx главной страницы (где находится FAQBlock).
// Создаёт JSON-LD для FAQPage с 13 вопросами.
// HomepageSchema.tsx покрывает Book/Person/WebSite/BookSeries — здесь только FAQ.
// ============================================================
